...
class AppFrame(wx.Frame):
    ...
    def draw_paper_size_guides(self):
        ...
        self.paper_size, 'portrait' if self.paper_orientation == 'P' else 'landscape')
        ...
        guide = Element(name=current_paper_properties, type='R', x1=0, y1=0,
                        x2=PAPER_SIZE_OPTIONS[current_paper_properties][0],
                        y2=PAPER_SIZE_OPTIONS[current_paper_properties][1], font="Arial", size=70, bold=False,
                        italic=False, underline=False, foreground=0x808080, background=0xFFFFFF, align="L", text='',
                        priority=-100, canvas=self.canvas, frame=self, static=True)
    ...
    def do_print(self, evt):
        ...
        t = Template(format=paper_size, orientation=orientation,
